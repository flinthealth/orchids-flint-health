Create a new file src/components/sections/measure-and-grow.tsx with "use client" at the top.
The section uses the brand gradient background linear-gradient(to right, #3d4d58 0%, #6b4b3e 55%, #a0522d 100%) with grain overlay matching the other gradient sections on the page.
Add a <style> tag inside the return for responsive CSS.
  ...
  return (
    <section style={{ background: 'linear-gradient(to right, #3d4d58 0%, #6b4b3e 55%, #a0522d 100%)' }} className="relative w-full overflow-hidden">
      ...
      <style>{`
        ...
        .mag-card { background: rgba(249,245,239,0.08); border: 0.5px solid rgba(249,245,239,0.15); border-radius: 12px; overflow: hidden; margin-top: 12px; }
        .mag-metrics { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; background: rgba(249,245,239,0.06); }
        .mag-metric { background: rgba(249,245,239,0.1); padding: 14px 12px; }
        ...
        .mag-pills { display: flex; flex-wrap: wrap; gap: 6px; padding: 12px 14px; background: rgba(249,245,239,0.04); border-bottom: 0.5px solid rgba(249,245,239,0.08); }
        @media (min-width: 768px) { .mag-pills { gap: 8px; padding: 14px 18px; } }
        .mag-pill { font-size: 10px; font-weight: 600; letter-spacing: 0.06em; text-transform: uppercase; padding: 4px 10px; border-radius: 20px; color: #f9f5ef; border: 0.5px solid rgba(249,245,239,0.2); background: rgba(249,245,239,0.08); }
        .mag-pill.orange { background: rgba(255,127,41,0.2); border-color: rgba(255,127,41,0.35); }
        .mag-pill.gold { background: rgba(238,178,11,0.2); border-color: rgba(238,178,11,0.35); }
        .mag-pill.blue { background: rgba(84,129,154,0.2); border-color: rgba(84,129,154,0.35); }
        .mag-pill.teal { background: rgba(84,154,140,0.2); border-color: rgba(84,154,140,0.35); }

        .mag-body { padding: 14px 14px; background: rgba(249,245,239,0.04); }
        @media (min-width: 768px) { .mag-body { padding: 16px 18px; } }
        .mag-body-label { font-size: 10px; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; color: rgba(249,245,239,0.35); margin-bottom: 10px; }
        ...
        .mag-engage-meta { display: flex; justify-content: space-between; font-size: 11px; color: rgba(249,245,239,0.5); }
        ...
        .mag-col { background: rgba(249,245,239,0.06); padding: 12px 14px; }
        @media (min-width: 768px) { .mag-col { padding: 14px 16px; } }
        .mag-col-label { font-size: 10px; font-weight: 600; letter-spacing: 0.07em; text-transform: uppercase; color: rgba(249,245,239,0.35); margin-bottom: 8px; }
        .mag-col-item { font-size: 11px; color: rgba(249,245,239,0.55); padding: 4px 0; border-bottom: 0.5px solid rgba(249,245,239,0.06); display: flex; justify-content: space-between; }
        @media (min-width: 768px) { .mag-col-item { font-size: 12px; } }
        .mag-col-item:last-child { border-bottom: none; }
        .mag-col-item span { color: rgba(249,245,239,0.9); font-weight: 500; }
        ...
        .mag-section-sub { font-size: 11px; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; color: rgba(249,245,239,0.4); }
      `}</style>
      ...
      <div className="relative z-10 mag-wrap">
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: 14, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#ede4da', marginBottom: 14 }}>Don&rsquo;t guess if it works. Prove it does.</p>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <div className="mag-card">
            <div className="mag-metrics">
              <div className="mag-metric">
                <div className="mag-metric-val gold">139K+</div>
                <div className="mag-metric-label">Total listens</div>
              </div>
              <div className="mag-metric">
                <div className="mag-metric-val orange">+257%</div>
                <div className="mag-metric-label">Intake inquiries vs. pre-series</div>
              </div>
              <div className="mag-metric">
                <div className="mag-metric-val">81%</div>
                <div className="mag-metric-label">Avg episode completion</div>
              </div>
            </div>
            ...
            <div className="mag-pills">
              ...
              <span className="mag-pill">Referral attribution</span>
              <span className="mag-pill teal">Intakes scheduled</span>
              <span className="mag-pill blue">Listener acquisition</span>
            </div>
...
Do not create any other files or change any other files. Export default as MeasureAndGrow.