Balanced. Here's the prompt.
File: src/components/sections/series-reach.tsx
Replace the entire contents of this file with the code below. Do not change the file path or the component name. This moves each stat to sit below its description instead of beside it, and gives each stat its own color instead of one shared accent.
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-start">
          ...
          <div className="flex-1 flex flex-col w-full">
            {ROWS.map(({ Icon, label, desc, stat, statColor, statDesc, cite, citeUrl }, i) => (
              <div
                key={label}
              ...
              >
                ...
                {stat && (
                  <div className="pl-[30px]">
                    <div style={{ fontSize: 28, fontWeight: 300, color: statColor, lineHeight: 1 }}>{stat}</div>
