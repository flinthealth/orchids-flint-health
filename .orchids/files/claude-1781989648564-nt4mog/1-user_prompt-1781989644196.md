...
Replace the entire contents of this file with the code below. Do not change the file path or the component name. Icons are now gray except Team's, which uses a warm brown-orange matching the brand gradient's end color. Stat numbers stay dark, with each stat in a soft tinted callout box with a colored left edge instead of a colored number.
...
This must render correctly at all breakpoints: below 768px, the 768px md breakpoint, and the 1200px lg breakpoint. Do not change anything else in the project.