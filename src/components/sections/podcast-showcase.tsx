  ...
  return (
    <div className="bg-white overflow-hidden flex flex-col" style={fadeStyle}>
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="p-8">
          <p className="text-[#2b3335]/50 text-[11px] font-semibold tracking-[0.18em] uppercase mb-1">{tag}</p>
          <h3 className="text-[#2b3335] text-[28px] font-light leading-[1.1] tracking-[-0.02em]">{title}</h3>
          <p className="text-[#54819a] text-[13px] font-medium mt-1 mb-5">{client}</p>
          <div className="flex flex-col gap-3">
            {description.split('\n\n').map((para, j) => (
              <p key={j} className="text-[#677283] text-[14px] leading-[1.7]">{para}</p>
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="hidden md:flex flex-row gap-8 p-10 pb-8">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[#2b3335]/50 text-[11px] font-semibold tracking-[0.18em] uppercase mb-1">{tag}</p>
          <h3 className="text-[#2b3335] text-[32px] font-light leading-[1.1] tracking-[-0.02em]">{title}</h3>
          <p className="text-[#54819a] text-[13px] font-medium mt-1 mb-5">{client}</p>
          <div className="flex flex-col gap-3">
            {description.split('\n\n').map((para, j) => (
              <p key={j} className="text-[#677283] text-[14px] leading-[1.7]">{para}</p>
  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-[620px] mx-auto mb-16">
        ...
        <h2
          className="text-[#43382f] text-[40px] md:text-[52px] font-light leading-[1.1] tracking-[-0.02em] mb-5"
          style={fade(0)}
        >
        ...
        <p className="text-[#677283] text-[15px] md:text-[16px] leading-[1.65]" style={fade(0.2)}>
