  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      ...
      {false && isBannerVisible && (
        <div className="bg-[#2b3335] text-white py-2 px-10 relative flex justify-center items-center">
          <p className="text-[14px] leading-[1.4] font-normal text-center">
            New: Healthcare Podcast Strategy Guide 2026 |{' '}
            <a href="/resources" className="underline hover:text-[#eeb20b] transition-colors">
              Download now
            </a>
          </p>
          <button
