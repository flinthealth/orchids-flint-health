  ...
  return (
    <section className="relative overflow-hidden bg-[#ffffff] py-[120px] md:py-[160px] flex items-center justify-center">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, #eeb20b 0%, rgba(242, 240, 230, 0) 70%)',
          zIndex: 0
        }}
      />
      ...
      <div className="container relative z-10 px-4 mx-auto text-center max-w-[1280px]">
        <div className="max-w-[700px] mx-auto">
          {/* Headline */}
          <h2 className="text-[40px] md:text-[56px] leading-[1.1] font-normal text-[#2b3335] tracking-[-0.02em] mb-6">
            Bring your benefits <br />
            into <em className="font-serif italic text-inherit">the future</em>
          </h2>

          {/* Subtext */}
          <p className="text-[18px] md:text-[20px] leading-[1.5] text-[#2b3335] font-normal mb-10 max-w-[500px] mx-auto text-balance opacity-90">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="/for-employers"
              className="inline-flex items-center justify-center bg-[#2b3335] hover:bg-[#eeb20b] hover:text-[#43382f] text-[#ffffff] px-8 py-4 rounded-[6px] text-[16px] font-semibold transition-all duration-200 min-w-full sm:min-w-[180px]"
            >
              For businesses
            </a>
            <a
