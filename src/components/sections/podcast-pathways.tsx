...
export default function PodcastPathways() {
  ...
  return (
    <section ref={sectionRef} className="bg-[#f9f5ef] w-full pt-[28px] md:pt-12 pb-0">
      ...
      <div className="text-center mb-14 px-4 md:px-8">
        ...
        <h2
          className="text-[#43382f] text-[40px] md:text-[52px] font-light leading-[1.1] tracking-[-0.02em] mb-4"
          style={fade(0.1)}
        >
          Every series begins with <span className="font-serif italic">one question</span>
        </h2>
        <p
      ...
      <div className="flex flex-col md:hidden" style={fade(0.2)}>
        ...
        <div className="flex-1 px-8 py-12 flex flex-col" style={{ backgroundColor: 'rgba(19,29,43,0.07)' }}>
          <span
            ...
            style={{ backgroundColor: '#2b3335', color: '#ffffff' }}
          >
            Internal
          </span>
          <h3 className="text-[#43382f] text-[28px] font-light leading-[1.15] tracking-[-0.02em] mb-4 whitespace-nowrap">
            For your <span className="tracking-wide">ORGANIZATION</span>
          </h3>
          <p className="text-[#677283] text-[15px] leading-[1.7] mb-8 max-w-[400px]">
        ...
        {/* Public — mobile */}
        <div className="flex-1 px-8 py-12 flex flex-col" style={{ backgroundColor: '#2b3335' }}>
          <span
            className="inline-block self-start text-[11px] font-semibold tracking-[0.2em] uppercase px-4 py-1.5 rounded-full mb-6"
          ...
          <h3 className="text-[#ffffff] text-[28px] font-light leading-[1.15] tracking-[-0.02em] mb-4 whitespace-nowrap">
      ...
      <div className="hidden md:flex flex-row items-start justify-center gap-6 px-8 pb-2" style={fade(0.2)}>
        ...
        >
          ...
          <h3 className="text-[#43382f] text-[28px] md:text-[32px] font-light leading-[1.15] tracking-[-0.02em] mb-4 whitespace-nowrap">
            For your <span className="tracking-wide">ORGANIZATION</span>
          </h3>
        ...
        >
          ...
          <h3 className="text-[#ffffff] text-[28px] md:text-[32px] font-light leading-[1.15] tracking-[-0.02em] mb-4 whitespace-nowrap">
            For your <span className="tracking-wide">AUDIENCE</span>
          </h3>
      ...
      <div className="w-full bg-[#f9f5ef] overflow-hidden" aria-hidden="true" style={fade(0.25)}>
        <svg
