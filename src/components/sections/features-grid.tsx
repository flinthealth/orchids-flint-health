...
const ROW1 = [
  { label: "Humanize Your Brand",          color: "#43382f", bg: "#eeb20b" },
  { label: "Create Community Connection",  color: "#43382f", bg: "#eeb20b" },
  { label: "Generate Revenue",             color: "#43382f", bg: "#eeb20b" },
  { label: "Lift Brand Awareness",          color: "#ffffff", bg: "#54819a" },
];

const ROW2 = [
  { label: "Yield an Efficient & Measurable ROI", color: "#43382f", bg: "#eeb20b" },
  { label: "Establish Thought Leadership",         color: "#ffffff", bg: "#2b3335" },
  { label: "Patient Education & Empowerment",      color: "#43382f", bg: "#eeb20b" },
  { label: "Connect with Your Target Audience",    color: "#ffffff", bg: "#54819a" },
];

const ROW3 = [
  { label: "Build Strategic Partnerships",      color: "#43382f", bg: "#eeb20b" },
  { label: "Differentiate Your Brand",          color: "#ffffff", bg: "#2b3335" },
  { label: "Foster & Maintain Public Trust",    color: "#43382f", bg: "#eeb20b" },
  { label: "Deepen Engagement and Retention",   color: "#ffffff", bg: "#54819a" },
];
    ...
    <section className="bg-[#ffffff] py-[80px] md:py-[120px] overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-end mb-16">
          <div>
            <h2 className="text-[40px] md:text-[56px] leading-[1.1] text-[#2b3335] font-sans tracking-tight max-w-[580px]">
              <em className="font-serif italic">Skip the ad</em>—command true presence and relevancy
            </h2>
          </div>
          <div className="lg:pl-8">
            <p className="text-[15px] md:text-[17px] text-[#2b3335] font-sans leading-relaxed max-w-[420px] mb-5">
              It's rare for a brand to command more than 20 minutes of a consumer's attention.
            </p>
            <p className="text-[15px] md:text-[17px] text-[#2b3335] font-sans leading-relaxed max-w-[420px]">
