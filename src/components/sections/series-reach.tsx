      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-start">
          ...
          <div className="flex-1 flex flex-col w-full">
            {ROWS.map(({ Icon, iconColor, label, desc, stat, statColor, statDesc, cite, citeUrl }, i) => (
              <div
                key={label}
              ...
              >
                ...
                {stat && (
                  <div className="pl-[30px]">
                    <div style={{
                      background: `${statColor}1A`,
                      borderLeft: `3px solid ${statColor}`,
                      borderRadius: '6px',
                      padding: '12px 18px',
                      display: 'inline-block',
                      maxWidth: '420px',
                    }}>
                      <div style={{ fontSize: 28, fontWeight: 300, color: '#2b3335', lineHeight: 1 }}>{stat}</div>
                      <div style={{ fontSize: 13, color: '#677283', lineHeight: 1.4, marginTop: 4 }}>
                        {statDesc}
