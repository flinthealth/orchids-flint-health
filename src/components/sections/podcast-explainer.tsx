  ...
  return (
    <div ref={ref} className="flex-1 flex items-center justify-center min-h-0">
      <div className="relative w-full" style={{ maxWidth: '100%', aspectRatio: '1' }}>
        ...
        >
          <circle cx={VB_CX} cy={VB_CX} r={VB_R} fill="none" stroke="rgba(70,71,72,0.2)" strokeWidth={VB_STROKE} />
          <circle cx={VB_CX} cy={VB_CX} r={VB_R} fill="none" stroke="#464748" strokeWidth={VB_STROKE}
            strokeLinecap="round" strokeDasharray={VB_C} strokeDashoffset={offset} />
        </svg>
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-[#2b3335] font-light leading-none tracking-[-0.03em]" style={{ fontSize: 'clamp(36px, 12cqw, 66px)' }}>{pct}%</span>
          <span className="text-[#2b3335]/50 font-semibold tracking-[0.1em] uppercase mt-1" style={{ fontSize: 'clamp(8px, 2cqw, 11px)' }}>complete</span>
        </div>
      </div>
    </div>
  );
      ...
      <div className="relative" style={{ width: W, height: W / 2 + 24 }}>
        <svg width={W} height={W / 2 + 24} viewBox={`0 0 ${W} ${W / 2 + 24}`}>
          ...
          <line
            x1={CX} y1={CY}
            x2={nx} y2={ny}
            stroke="#eeb20b" strokeWidth="3" strokeLinecap="round"
            style={{ transition: 'all 0.05s linear' }}
          />
          {/* Pivot dot */}
          <circle cx={CX} cy={CY} r="5" fill="#eeb20b" />
        </svg>
...
const RING_STATS = [
  { value: 61, label: 'Brand Favorability',  sub: 'of listeners report a more positive view of the brand',          color: '#f9f5ef', Icon: StatIconHeart     },
  { value: 75, label: 'Deep Attention',       sub: 'agree the content keeps their attention for the entire episode', color: '#eeb20b', Icon: StatIconEye        },
  { value: 77, label: 'Daily Integration',    sub: 'engage while multitasking — commuting, exercising, or working',  color: '#eeb20b', Icon: StatIconHeadphones },
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 pt-2 pb-8" style={{ height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <p className="text-[#2b3335]/40 text-[11px] font-semibold tracking-[0.2em] uppercase mb-8">A brief history</p>
              ...
              <div key={year} className="flex items-start gap-6 mb-9 relative">
                ...
                >
                  ...
                  <div className="flex-1 pt-0.5">
                    <span
                      className="inline-block text-[11px] font-semibold tracking-[0.06em] px-3 py-1 rounded-full whitespace-nowrap mb-1.5 border border-[#2b3335]"
                      style={{ backgroundColor: '#eeb20b', color: '#2b3335' }}
                    >
                      {year}
                    </span>
...
const ACCENT_COLORS = ['#eeb20b', '#6b4b3e', '#2b3335', '#eeb20b', '#2b3335'];
    ...
    <section id="solutions" className="bg-[#f9f5ef]">
      <div className="container mx-auto px-8 pt-[80px] pb-[60px]">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-[#2b3335] text-[38px] md:text-[52px] font-light leading-[1.15] tracking-[-0.02em] mb-6 max-w-[720px] mx-auto">
            Series capture attention in a <span className="font-serif italic">world full of noise</span>
          </h2>
          <p className="text-[#677283] text-[15px] md:text-[16px] leading-[1.7] max-w-[580px] mx-auto mb-6">
            We lead with long-form audio and video series. The format with the highest trust, the deepest engagement, and the stats to prove it.
          </p>
        </div>
          ...
          */}
          ...
          >
            ...
            <div
              ...
              style={{ gridColumn: '5 / 13', gridRow: '1 / 5', backgroundColor: '#4a5a66' }}
            >
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/icon-brain-recall.png" alt="" aria-hidden="true" className="absolute pointer-events-none z-0" style={{ right: '3%', top: '4%', width: '54%', maxWidth: 330, opacity: 0.93 }} />
              <div className="relative z-10">
                ...
                <p className="text-[#ffffff]/60 text-[14px] leading-[1.6] max-w-[360px]">Information woven into a narrative is recalled six to seven times more than information studied through repetition alone — meaning your message doesn't just land, it sticks.</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="mt-5">
                ...
                <p className="text-[#2b3335]/60 text-[14px] leading-[1.6]">While other long-form media struggles to hold attention, our leading formats ensure your vital messages are heard, absorbed, and complete.</p>
              </div>
            </div>
            ...
            <div
              className="rounded-3xl p-6 flex flex-col relative overflow-hidden"
              style={{ gridColumn: '5 / 9', gridRow: '9 / 13', background: 'linear-gradient(to bottom, #3d4d58 0%, #6b4b3e 55%, #a0522d 100%)' }}
            >
            ...
            >
              <div>
                <p className="text-[#43382f]/40 text-[11px] font-semibold tracking-[0.2em] uppercase mb-2">The bottom line</p>
                <p className="text-[#43382f] text-[22px] md:text-[26px] font-light leading-[1.3] max-w-[820px]">
          ...
          <div className="flex md:hidden flex-col gap-3">
            ...
            <div className="rounded-3xl overflow-hidden relative px-7 pt-7 pb-7 flex flex-col" style={{ backgroundColor: '#4a5a66' }}>
              ...
              <div className="relative z-10 flex flex-col">
                {/* Brain image — centered above text */}
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <div className="flex justify-center mb-2">
                  <img src="/icon-brain-recall.png" alt="" aria-hidden="true" style={{ width: '69%', maxWidth: 253, opacity: 0.93 }} />
                </div>
                {/* Text below */}
            ...
            <div className="rounded-3xl pt-6 px-7 pb-7 flex flex-col items-center min-h-[280px]" style={{ backgroundColor: '#e8e3de' }}>
              ...
              <p className="text-[#2b3335]/60 text-[14px] leading-[1.6] text-center">Most listeners stay engaged from the first insight to the final conclusion.</p>
            </div>
            ...
            <div className="py-6 text-center">
              <p className="text-[#43382f]/40 text-[11px] font-semibold tracking-[0.2em] uppercase mb-4">The bottom line</p>
              <p className="text-[#43382f] text-[26px] font-light leading-[1.3]">
