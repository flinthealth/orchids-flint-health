    ...
    <section style={{ background: "#f9f5ef" }} className="w-full pt-12 pb-24 px-6 md:px-12 overflow-hidden">
      <div className="max-w-[1280px] mx-auto">
        ...
        <p className="max-w-[780px] mb-10 mt-4 text-[19px] text-[#43382f] leading-relaxed">
          ...
          <span className="text-[16px] font-medium uppercase tracking-[0.08em] leading-[1.8]" style={{ color: '#677283', display: 'block', marginTop: '4px' }}>Lost time.<br />Missed outcomes.<br />Avoidable setbacks.</span>
        </p>
