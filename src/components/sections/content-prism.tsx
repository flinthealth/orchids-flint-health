    ...
    content: (_dark: boolean) => {
      ...
      return (
        <div className="flex flex-col gap-5">
          <p style={{ color: body }} className="text-[16px] leading-[1.5]">
          ...
          <div className="flex flex-col gap-2.5">
            {[
              { label: "Define the outcome you need",                         desc: "Anchor every creative decision to the result you're building toward." },
              { label: "Understand your audience",                            desc: "Who they are, how they consume content, and what moves them to act." },
    ...
    content: (_dark: boolean) => {
      ...
      return (
        <div className="flex flex-col gap-5">
          ...
          <p style={{ color: body }} className="text-[15px] leading-[1.5]">
...
export default function ContentPrism() {
  ...
  return (
    <section
      ref={sectionRef}
      id="process"
      className="relative px-4 md:px-8 pt-[40px] md:pt-[80px] pb-[80px] md:pb-[120px] bg-[#f9f5ef]"
    >
      {/* ── Header ── */}
      <div className="text-center max-w-[680px] mx-auto mb-10">
        ...
        <h2
          className="text-[#2b3335] text-[40px] md:text-[54px] font-light leading-[1.1] tracking-[-0.02em] mb-5"
          style={{
            opacity:    visible ? 1 : 0,
        ...
        <p
          className="text-[#2b3335]/70 text-[17px] leading-[1.5] max-w-[560px] mx-auto"
          style={{
            opacity:    visible ? 1 : 0,
            transform:  visible ? "translateY(0)" : "translateY(16px)",
      ...
      >
        {STEPS.map((step, i) => {
          ...
          const headingColor = isDark ? '#2b3335'             : '#ffffff';
          ...
          return (
            ...
            >
              ...
              >
                {/* Number — desktop */}
                <div className="hidden md:block flex-shrink-0 text-center" style={{ minWidth: 'clamp(52px, 5.5vw, 80px)' }}>
                  <span
                ...
                {/* Number — mobile */}
                <div className="md:hidden flex-shrink-0 text-center" style={{ minWidth: '42px' }}>
                  <span
                    className="font-light select-none"
                    style={{
                      display: 'inline-block',
                ...
                <div className="flex-1 min-w-0">
                  <h3
                    className="text-[17px] md:text-[24px] font-light tracking-[-0.01em] leading-[1.2] mb-1"
