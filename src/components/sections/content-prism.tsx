          ...
          <div className="flex flex-col gap-2">
            {[
              ...
              <div key={i} className="rounded-xl px-4 py-3.5" style={{ background: "rgba(107,75,62,0.35)" }}>
                ...
                <p className="text-[13px]" style={{ color: 'rgba(43,51,53,0.55)' }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
...
export default function ContentPrism() {
  ...
  return (
    <section
      ref={sectionRef}
      id="process"
      className="relative px-4 md:px-8 pt-[40px] md:pt-[80px] pb-[40px] bg-[#f9f5ef]"
    >
      {/* ── Header ── */}
