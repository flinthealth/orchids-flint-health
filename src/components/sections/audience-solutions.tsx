      ...
      <div className="container mx-auto px-8 md:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="flex flex-col max-w-[540px]">
            <div className="mb-5">
              <span className="inline-block bg-[#ffffff] text-[#2b3335] text-[11px] font-semibold tracking-[0.2em] uppercase px-4 py-1.5 rounded-full border border-[#2b3335]">
                Bridge the Gaps
              </span>
            </div>
                ...
                return (
                  <div key={s.name} className="flex flex-col">
                    <button
                      ...
                      style={{
                        backgroundColor: isActive ? '#2b3335' : '#f9f5ef',
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <span
                          ...
                          style={{ color: isActive ? '#ffffff' : '#2b3335' }}
                        >
                          {s.name}
                        </span>
                      </div>
                      ...
                      >
                        ...
                        >
                          {(s.description as string[]).map((para, pi) => (
                            <p
                              key={pi}
                              className="text-[#2b3335] text-[14px] leading-[1.65]"
